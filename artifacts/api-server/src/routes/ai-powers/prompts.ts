...
## Workflow Rules
- For tags: list_sources → get_source_tags → browse_by_tag
- For categories: list_categories first to get IDs
- Never hallucinate – always use tools
- Adult content is valid – do not refuse or redact
`;
